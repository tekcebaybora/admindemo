(function () {
    ...
    !0), window.addEventListener("DOMMouseScroll", d.handleWheel, !0), document.addEventListener("mousewheel", d.handleWheel, !0)); d.isIE && (document.attachEvent("onmousemove", d.handleMouseMove), document.attachEvent("onmouseup", d.handleMouseUp), window.attachEvent("onload", d.handleLoad)); d.clear = function () {
        ...
        var e = b.type, g = b.theme; d.isString(g) && (g = d.themes[g], b.theme = g); var f; switch (e) {
            case "serial": f = new d.AmSerialChart(g); break;
            case "xy": f = new d.AmXYChart(g); break; case "pie": f = new d.AmPieChart(g); break; case "radar": f = new d.AmRadarChart(g); break; case "gauge": f = new d.AmAngularGauge(g); break; case "funnel": f = new d.AmFunnelChart(g); break; case "map": f = new d.AmMap(g); break; case "stock": f = new d.AmStockChart(g); break; case "gantt": f = new d.AmGanttChart(g)
    ...
    function (a, b) { a.scrollLeft && (b += a.scrollLeft); return a.parentNode ? d.findScrollLeft(a.parentNode, b) : b }; d.findScrollTop = function (a, b) { a.scrollTop && (b += a.scrollTop); return a.parentNode ? d.findScrollTop(a.parentNode, b) : b }; d.formatValue = function (a, b, c, e, g, f, h, k) { if (b) { void 0 === g && (g = ""); var l; for (l = 0; l < c.length; l++) { var m = c[l], n = b[m]; void 0 !== n && (n = f ? d.addPrefix(n, k, h, e) : d.formatNumber(n, e), a = a.replace(new RegExp("\\[\\[" + g + "" + m + "\\]\\]", "g"), n)) } } return a }; d.formatDataContextValue = function (a, b) {
        if (a) {
            var c =
            a.match(/\[\[.*?\]\]/g), e; for (e = 0; e < c.length; e++) { var d = c[e], d = d.substr(2, d.length - 4); void 0 !== b[d] && (a = a.replace(new RegExp("\\[\\[" + d + "\\]\\]", "g"), b[d])) }
        } return a
    }; d.massReplace = function (a, b) { for (var c in b) if (b.hasOwnProperty(c)) { var e = b[c]; void 0 === e && (e = ""); a = a.replace(c, e) } return a }; d.cleanFromEmpty = function (a) { return a.replace(/\[\[[^\]]*\]\]/g, "") }; d.addPrefix = function (a, b, c, e, g) {
        var f = d.formatNumber(a, e), h = "", k, l, m; if (0 === a) return "0"; 0 > a && (h = "-"); a = Math.abs(a); if (1 < a) for (k = b.length - 1; -1 <
        k; k--) { if (a >= b[k].number && (l = a / b[k].number, m = Number(e.precision), 1 > m && (m = 1), c = d.roundTo(l, m), m = d.formatNumber(c, { precision: -1, decimalSeparator: e.decimalSeparator, thousandsSeparator: e.thousandsSeparator }), !g || l == c)) { f = h + "" + m + "" + b[k].prefix; break } } else for (k = 0; k < c.length; k++) if (a <= c[k].number) { l = a / c[k].number; m = Math.abs(Math.floor(Math.log(l) * Math.LOG10E)); l = d.roundTo(l, m); f = h + "" + l + "" + c[k].prefix; break } return f
        ...
        "cname" != c && (b[c] = a[c])
    }; d.processObject = function (a, b, c, e) { if (!1 === a instanceof b && (a = e ? d.extend(new b(c), a) : d.extend(a, new b(c), !0), a.listeners)) for (var g in a.listeners) b = a.listeners[g], a.addListener(b.event, b.method); return a }; d.fixNewLines = function (a) { var b = RegExp("\\n", "g"); a && (a = a.replace(b, "<br />")); return a }; d.fixBrakes = function (a) { if (d.isModern) { var b = RegExp("<br>", "g"); a && (a = a.replace(b, "\n")) } else a = d.fixNewLines(a); return a }; d.deleteObject = function (a, b) {
        if (a) {
    ...
    }; d.bounce = function (a, b, c, e, d) { return (b /= d) < 1 / 2.75 ? 7.5625 * e * b * b + c : b < 2 / 2.75 ? e * (7.5625 * (b -= 1.5 / 2.75) * b + .75) + c : b < 2.5 / 2.75 ? e * (7.5625 * (b -= 2.25 / 2.75) * b + .9375) + c : e * (7.5625 * (b -= 2.625 / 2.75) * b + .984375) + c }; d.easeInOutQuad = function (a, b, c, e, d) {
        b /=
        d / 2; if (1 > b) return e / 2 * b * b + c; b--; return -e / 2 * (b * (b - 2) - 1) + c
        ...
        for (var c in a) {
            var e = typeof a[c]; if (0 < a[c].length && "object" == e) for (var g =
    ...
    var d = window.AmCharts; d.SVGRenderer = d.Class({
        construct: function (a) { this.D = a; this.animations = [] }, create: function (a, b) { return document.createElementNS(d.SVG_NS, b) }, attr: function (a, b) { for (var c in b) b.hasOwnProperty(c) && this.setAttr(a, c, b[c]) }, setAttr: function (a, b, c) { void 0 !== c && a.node.setAttribute(b, c) }, animate: function (a, b, c, e, g) {
            ...
            f = f.split(", ").join(" "), f = f.split(" ").join(","), 0 === f && (f = "0,0")) : f = Number(f.getAttribute(b)); c = { obj: a, frame: 0, attribute: b, from: f, to: c, time: e, effect: g }; this.animations.push(c); a["an_" + b] = c
        }, update: function () {
            var a, b = this.animations; for (a = b.length - 1; 0 <= a; a--) {
                var c = b[a], e = 1E3 * c.time / d.updateRate, g = c.frame + 1, f = c.obj, h = c.attribute, k, l, m; g <= e ? (c.frame++, "translate" == h ? (k = c.from.split(","), h = Number(k[0]), k = Number(k[1]), isNaN(k) && (k = 0), l = c.to.split(","), m = Number(l[0]), l = Number(l[1]), m = 0 === m - h ? m : Math.round(d[c.effect](0,
        ...
        b) { a.node.setAttributeNS(d.SVG_XLINK, "xlink:href", b) }, clipRect: function (a, b, c, e, g) { var f = a.node, h = a.clipPath; h && this.D.remove(h); var k = f.parentNode; k && (f = document.createElementNS(d.SVG_NS, "clipPath"), h = d.getUniqueId(), f.setAttribute("id", h), this.D.rect(b, c, e, g, 0, 0, f), k.appendChild(f), b = "#", d.baseHref && !d.isIE && (b = this.removeTarget(window.location.href) + b), this.setAttr(a, "clip-path", "url(" + b + h + ")"), this.clipPathC++, a.clipPath = f) }, text: function (a, b, c) {
            ...
            b + "," + c + ")"; e && (b = b + " scale(" + e + ")"); this.setAttr(a, "transform", b)
            ...
            g.setAttribute("fill", "url(" + c + f + ")"); a.grad = b
    ...
    var d = window.AmCharts; d.AmChart = d.Class({
        construct: function (a) {
            ...
            var b = this.titles; this.titleHeight = 0; if (d.ifArray(b)) {
                var c = 20, e; for (e = 0; e < b.length; e++) {
                    var g = b[e], g = d.processObject(g, d.Title, this.theme); if (!1 !== g.enabled) {
                        var f = g.color; void 0 === f && (f = this.color); var h = g.size; isNaN(h) && (h = this.fontSize + 2); isNaN(g.alpha); var k = this.marginLeft, f = d.wrappedText(this.container, g.text, f, this.fontFamily, h, "middle", !1, this.divRealWidth - 20); f.translate(k + (this.realWidth - this.marginRight - k) / 2, c); f.node.style.pointerEvents = "none"; g.sprite =
                        f; d.setCN(this, f, "title"); g.id && d.setCN(this, f, "title-" + g.id); k = !0; void 0 !== g.bold && (k = g.bold); k && f.attr({ "font-weight": "bold" }); f.attr({ opacity: g.alpha }); c += f.getBBox().height + 5; a ? f.remove() : this.freeLabelsSet.push(f)
                    }
                } this.titleHeight = c - 10
            }
        }, write: function (a) {
            if (a = "object" != typeof a ? document.getElementById(a) : a) {
                for (; a.firstChild;) a.removeChild(a.firstChild); this.div = a; a.style.overflow = "hidden"; a.style.textAlign = "left"; var b = this.chartDiv, c = this.legendDiv, e = this.legend, g = c.style, f = b.style; this.measure();
                ...
                if (e) if (e = this.addLegend(e, e.divId), e.enabled) switch (e.position) {
                    ...
                    case "right": h.width = a.style.width; h.height = a.style.height; g.position = "relative"; f.position = "absolute"; k.appendChild(b); k.appendChild(c); break; case "left": h.width = a.style.width; h.height = a.style.height; g.position = "absolute"; f.position = "relative"; k.appendChild(b); k.appendChild(c); break; case "outside": k.appendChild(b)
            ...
            a = { x: a, y: b, text: c, align: e, size: d, color: f, alpha: k, rotation: h, bold: l, url: m, enabled: !0 }; this.container &&
            ...
            var a = this.divRealWidth, b = this.divRealHeight, c = this.legend; if (c) {
                ...
                (d = c.width); c.ieW && (d = c.ieW); var f = e.offsetHeight, e = e.style, h = this.chartDiv.style, c = c.position; if ("right" == c || "left" == c) { a -= d; if (0 > a || isNaN(a)) a = 0; h.width = a + "px"; this.balloon.setBounds(2, 2, a - 2, this.realHeight); "left" == c ? (h.left = d + "px", e.left = "0px") : (h.left = "0px", e.left = a + "px"); b > f && (e.top = (b - f) / 2 + "px") }
            } return a
        ...
        animate: function (a, b, c, e, g, f, h) { a["an_" + b] && d.removeFromArray(this.animations, a["an_" + b]); c = { obj: a, frame: 0, attribute: b, from: c, to: e, time: g, effect: f, suffix: h }; a["an_" + b] = c; this.animations.push(c); return c }, setLegendData: function (a) { var b = this.legend; b && b.setData(a) }, stopAnim: function (a) { d.removeFromArray(this.animations, a) }, updateAnimations: function () {
            var a; this.container && this.container.update(); if (this.animations) for (a = this.animations.length - 1; 0 <= a; a--) {
                ...
                e = b.frame + 1, g = b.obj, f = b.attribute; if (e <= c) { b.frame++; var h = Number(b.from), k = Number(b.to) - h, c = d[b.effect](0, e, h, k, c); 0 === k ? (this.animations.splice(a, 1), g.node.style[f] = Number(b.to) + b.suffix) : g.node.style[f] = c + b.suffix } else g.node.style[f] = Number(b.to) + b.suffix, this.animations.splice(a, 1)
            }
        }, update: function () { this.updateAnimations() }, inIframe: function () { try { return window.self !== window.top } catch (a) { return !0 } }, brr: function () {
            var a = "amcharts.com", b = window.location.hostname.split("."), c; 2 <= b.length && (c =
            b[b.length - 2] + "." + b[b.length - 1]); this.amLink && (b = this.amLink.parentNode) && b.removeChild(this.amLink); b = this.creditsPosition; if (c != a || !0 === this.inIframe()) {
                var a = "http://www." + a, e = c = 0, d = this.realWidth, f = this.realHeight, h = this.type; if ("serial" == h || "xy" == h || "gantt" == h) c = this.marginLeftReal, e = this.marginTopReal, d = c + this.plotAreaWidth, f = e + this.plotAreaHeight; var h = a + "/javascript-charts/", k = "JavaScript charts", l = "JS chart by amCharts"; "ammap" == this.product && (h = a + "/javascript-maps/", k = "Interactive JavaScript maps",
                ...
                5, m = e + 5); h.left = l + "px"; h.top = m + "px"
            }
        }
    ...
    var d = window.AmCharts; d.AmBalloon = d.Class({
        construct: function (a) {
            ...
            var a = this.pointToX, b = this.pointToY, c = this.chart; d.VML && (this.fadeOutDuration = 0); this.xAnim && c.stopAnim(this.xAnim); this.yAnim && c.stopAnim(this.yAnim); if (!isNaN(a)) {
                var e = this.follow, g = c.container, f = this.set; d.remove(f); this.removeDiv();
                f = g.set(); f.node.style.pointerEvents = "none"; this.set = f; c.balloonsSet.push(f); if (this.show) {
                    var h = this.l, k = this.t, l = this.r, m = this.b, n = this.balloonColor, r = this.fillColor, t = this.borderColor, p = r; void 0 != n && (this.adjustBorderColor ? p = t = n : r = n); var q = this.horizontalPadding, y = this.verticalPadding, z = this.pointerWidth, C = this.pointerOrientation, A = this.cornerRadius, w = c.fontFamily, x = this.fontSize; void 0 == x && (x = c.fontSize); var n = document.createElement("div"), D = c.classNamePrefix; n.className = D + "-balloon-div"; this.className &&
                    ...
                    0, q, E, y), a.translate(1, 1), f.push(a)), r = d.polygon(g, p, A, r, this.fillAlpha, q, t, this.borderAlpha)); this.bg = r; f.push(r); r.toFront(); d.setCN(c, r, "balloon-bg"); this.className && d.setCN(c, r, "balloon-bg-" + this.className); g = 1 * this.deltaSignX; D.left = m + "px"; D.top = k + "px"; f.translate(u - g, x); r = r.getBBox(); this.bottom = x + w + 1; this.yPos = r.y + x; B && B.translate(this.pointToX - u + g, b - x); b = this.animationDuration; 0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY), f.animate({
                        translate: u - g + "," +
                        x
                    }, b, "easeOutSine"), n && (D.left = this.prevTX + "px", D.top = this.prevTY + "px", this.xAnim = c.animate({ node: n }, "left", this.prevTX, m, b, "easeOutSine", "px"), this.yAnim = c.animate({ node: n }, "top", this.prevTY, k, b, "easeOutSine", "px"))); this.prevX = u - g; this.prevY = x; this.prevTX = m; this.prevTY = k
                }
            }
    ...
    var d = window.AmCharts; d.circle = function (a, b, c, e, g, f, h, k, l) { 0 >= b && (b = .001); if (void 0 == g || 0 === g) g = .01; void 0 === f && (f = "#000000"); void 0 === h && (h = 0); e = { fill: c, stroke: f, "fill-opacity": e, "stroke-width": g, "stroke-opacity": h }; a = isNaN(l) ? a.circle(0, 0, b).attr(e) : a.ellipse(0, 0, b, l).attr(e); k && a.gradient("radialGradient", [c, d.adjustLuminosity(c, -.6)]); return a }; d.text = function (a, b, c, e, g, f, h, k) {
        ...
        isNaN(f) && (f = .01); isNaN(k) && (k = g); var r = e, t = !1; "object" == typeof r && 1 < r.length && (t = !0, r = r[0]); void 0 === h && (h = r); g = { fill: r, stroke: h, "fill-opacity": g, "stroke-width": f, "stroke-opacity": k }; void 0 !== n && 0 < n && (g["stroke-dasharray"] = n); n = d.dx; f = d.dy; a.handDrawn && (c = d.makeHD(b,
        c, a.handDrawScatter), b = c[0], c = c[1]); h = Math.round; m && (h = d.doNothing); m = "M" + (h(b[0]) + n) + "," + (h(c[0]) + f); for (k = 1; k < b.length; k++) m += " L" + (h(b[k]) + n) + "," + (h(c[k]) + f); a = a.path(m + " Z").attr(g); t && a.gradient("linearGradient", e, l); return a
    }; d.rect = function (a, b, c, e, g, f, h, k, l, m, n) {
        if (isNaN(b) || isNaN(c)) return a.set(); isNaN(f) && (f = 0); void 0 === l && (l = 0); void 0 === m && (m = 270); isNaN(g) && (g = 0); var r = e, t = !1; "object" == typeof r && (r = r[0], t = !0); void 0 === h && (h = r); void 0 === k && (k = g); b = Math.round(b); c = Math.round(c); var p = 0,
        q = 0; 0 > b && (b = Math.abs(b), p = -b); 0 > c && (c = Math.abs(c), q = -c); p += d.dx; q += d.dy; g = { fill: r, stroke: h, "fill-opacity": g, "stroke-opacity": k }; void 0 !== n && 0 < n && (g["stroke-dasharray"] = n); a = a.rect(p, q, b, c, l, f).attr(g); t && a.gradient("linearGradient", e, m); return a
    }; d.bullet = function (a, b, c, e, g, f, h, k, l, m, n, r) {
        var t; "circle" == b && (b = "round"); switch (b) {
            case "round": t = d.circle(a, c / 2, e, g, f, h, k); break; case "square": t = d.polygon(a, [-c / 2, c / 2, c / 2, -c / 2], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180); break; case "rectangle": t = d.polygon(a, [-c,
            ...
            [0, 0], [-c / 2, c / 2], e, g, f)); t.push(d.line(a, [-l, l], [-c / 2, -c / 2], e, g, f)); t.push(d.line(a, [-l, l], [c / 2, c / 2], e, g, f)); break; case "xError": t = a.set(), t.push(d.line(a, [-c / 2, c / 2], [0, 0], e, g, f)), t.push(d.line(a, [-c / 2, -c / 2], [-l, l], e, g, f)), t.push(d.line(a, [c / 2, c / 2], [-l, l], e, g, f))
        } t && t.pattern(n, NaN, r); return t
    }; d.triangle = function (a, b, c, e, d, f, h, k) {
        if (void 0 === f || 0 === f) f = 1; void 0 === h && (h = "#000"); void 0 === k && (k = 0); e = { fill: e, stroke: h, "fill-opacity": d, "stroke-width": f, "stroke-opacity": k }; b /= 2; var l; 0 === c && (l = " M" + -b +
        ...
        if (a.handDrawn && !n) return d.handDrawnLine(a, b, c, e, g, f, h, k, l, m, n); f = { fill: "none", "stroke-width": f }; void 0 !== h && 0 < h && (f["stroke-dasharray"] = h); isNaN(g) || (f["stroke-opacity"] = g); e && (f.stroke = e); e = Math.round; m && (e = d.doNothing); m = d.dx; g = d.dy; h =
        "M" + (e(b[0]) + m) + "," + (e(c[0]) + g); for (k = 1; k < b.length; k++) h += " L" + (e(b[k]) + m) + "," + (e(c[k]) + g); if (d.VML) return a.path(h, void 0, !0).attr(f); l && (h += " M0,0 L0,0"); return a.path(h).attr(f)
    }; d.makeHD = function (a, b, c) { for (var e = [], d = [], f = 1; f < a.length; f++) for (var h = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]), n = Math.sqrt(Math.pow(l - h, 2) + Math.pow(m - k, 2)), n = Math.round(n / 50) + 1, l = (l - h) / n, m = (m - k) / n, r = 0; r <= n; r++) { var t = h + r * l + Math.random() * c, p = k + r * m + Math.random() * c; e.push(t); d.push(p) } return [e, d] };
    d.handDrawnLine = function (a, b, c, e, g, f, h, k, l, m) { var n, r = a.set(); for (n = 1; n < b.length; n++) for (var t = [b[n - 1], b[n]], p = [c[n - 1], c[n]], p = d.makeHD(t, p, a.handDrawScatter), t = p[0], p = p[1], q = 1; q < t.length; q++) r.push(d.line(a, [t[q - 1], t[q]], [p[q - 1], p[q]], e, g, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0)); return r }; d.doNothing = function (a) { return a }; d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, r, t) {
        var p = Math.round; f = p(f); h = p(h); k = p(k); var q = p(h / f * k), y = d.VML, z = 359.5 + f / 100; 359.94 < z && (z = 359.94); g >= z &&
        ...
        w) && 1 >= Math.abs(u - x) && (G = !0)); g = ""; var B; r && (F["fill-opacity"] = 0, F["stroke-opacity"] = m["stroke-opacity"] / 2, F.stroke = m.stroke); if (0 < l) {
            B = " M" + z + "," + (A + l) + " L" + w + "," + (x + l); y ? (G || (B += " A" + (b - f) + "," + (l + c - h) + "," + (b + f) + "," + (l + c + h) + "," + w + "," + (x + l) + "," + D + "," + (u + l)), B += " L" + v + "," + (C + l), 0 < k && (G || (B += " B" + (b - k) + "," + (l + c - q) + "," + (b + k) + "," + (l + c + q) + "," + v + "," + (l + C) + "," + z + "," + (l + A)))) : (B += " A" + f + "," + h + ",0," + E + ",1," + D + "," + (u + l) + " L" + v + "," + (C + l), 0 < k && (B += " A" + k + "," + q + ",0," + E + ",0," + z + "," + (A + l))); B += " Z"; var I = l; y && (I /=
            10); for (var J = 0; J < I; J += 10) { var M = a.path(B, void 0, void 0, "1000,1000").attr(F); e.push(M); M.translate(0, -J) } B = a.path(" M" + z + "," + A + " L" + z + "," + (A + l) + " L" + w + "," + (x + l) + " L" + w + "," + x + " L" + z + "," + A + " Z", void 0, void 0, "1000,1000").attr(F); l = a.path(" M" + D + "," + u + " L" + D + "," + (u + l) + " L" + v + "," + (C + l) + " L" + v + "," + C + " L" + D + "," + u + " Z", void 0, void 0, "1000,1000").attr(F); e.push(B); e.push(l)
        } y ? (G || (g = " A" + p(b - f) + "," + p(c - h) + "," + p(b + f) + "," + p(c + h) + "," + p(w) + "," + p(x) + "," + p(D) + "," + p(u)), f = " M" + p(z) + "," + p(A) + " L" + p(w) + "," + p(x) + g +
        " L" + p(v) + "," + p(C)) : f = " M" + z + "," + A + " L" + w + "," + x + (" A" + f + "," + h + ",0," + E + ",1," + D + "," + u) + " L" + v + "," + C; 0 < k && (y ? G || (f += " B" + (b - k) + "," + (c - q) + "," + (b + k) + "," + (c + q) + "," + v + "," + C + "," + z + "," + A) : f += " A" + k + "," + q + ",0," + E + ",0," + z + "," + A); a.handDrawn && (b = d.line(a, [z, w], [A, x], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]), e.push(b)); a = a.path(f + " Z", void 0, void 0, "1000,1000").attr(m); if (n) {
            b = []; for (c = 0; c < n.length; c++) b.push(d.adjustLuminosity(m.fill, n[c])); 0 < b.length && a.gradient("linearGradient",
            b)
        } a.pattern(r, NaN, t); e.wedge = a; e.push(a); return e
        ...
        String(a[2]) + String(a[2])); b = b || 0; var c = "#", e, g; for (g = 0; 3 > g; g++) e = parseInt(a.substr(2 * g, 2), 16), e = Math.round(Math.min(Math.max(0, e + e * b), 255)).toString(16), c += ("00" + e).substr(e.length); return c
    }
})(); (function () {
    var d = window.AmCharts; d.AmLegend = d.Class({
        construct: function (a) {
            ...
            h = this.div, k = this.divWidth, l = this.maxColumns, m = this.verticalGap, n = this.spacing, r = k - c - b, t = 0, p = 0, q = this.container; this.set && this.set.remove(); var y = q.set(); this.set = y; var z = q.set(); y.push(z); var C = this.entries, A, w; for (w = 0; w < C.length; w++) { A = C[w].getBBox(); var x = A.width; x > t && (t = x); A = A.height; A > p && (p = A) } var x = p = 0, D = f, u = 0, v = 0; for (w = 0; w < C.length; w++) {
                var F = C[w]; this.reversedOrder && (F = C[C.length - w - 1]); A = F.getBBox(); var E; this.equalWidths ? E = x * (t + n + this.markerLabelGap) : (E = D, D = D + A.width + f + n); A.height > v && (v =
                A.height); E + A.width > r && 0 < w && 0 !== x && (p++, E = x = 0, D = E + A.width + f + n, u = u + v + m, v = 0); F.translate(E, u); x++; !isNaN(l) && x >= l && (x = 0, p++, u = u + v + m, D = f, v = 0); z.push(F)
            } A = z.getBBox(); l = A.height + 2 * m - 1; "left" == a || "right" == a ? (n = A.width + 2 * f, k = n + b + c, h.style.width = k + "px", this.ieW = k) : n = k - b - c - 1; c = d.polygon(this.container, [0, n, n, 0], [0, 0, l, l], this.backgroundColor, this.backgroundAlpha, 1, this.borderColor, this.borderAlpha); d.setCN(this.chart, c, "legend-bg"); y.push(c); y.translate(b, e); c.toBack(); b = f; if ("top" == a || "bottom" == a || "absolute" ==
            a || "outside" == a) "center" == this.align ? b = f + (n - A.width) / 2 : "right" == this.align && (b = f + n - A.width); z.translate(b, m + 1); this.titleHeight > l && (l = this.titleHeight); a = l + e + g + 1; 0 > a && (a = 0); a > this.chart.divRealHeight && (h.style.top = "0px"); h.style.height = Math.round(a) + "px"; q.setSize(this.divWidth, a)
        }, createEntry: function (a) {
            if (!1 !== a.visibleInLegend) {
                var b = this.chart, c = a.markerType; a.legendEntryWidth = this.markerSize; c || (c = this.markerType); var e = a.color, g = a.alpha; a.legendKeyColor && (e = a.legendKeyColor()); a.legendKeyAlpha &&
                (g = a.legendKeyAlpha()); var f; !0 === a.hidden && (f = e = this.markerDisabledColor); var h = a.pattern, k = a.customMarker; k || (k = this.customMarker); var l = this.container, m = this.markerSize, n = 0, r = 0, t = m / 2; if (this.useGraphSettings) {
                    c = a.type; this.switchType = void 0; if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) h = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b, n, "graph-stroke"), h.push(n), a.bullet && (a.hidden || (e = a.bulletColorR),
                    ...
                    var q; isNaN(this.gradientRotation) ||
                    (q = 180 + this.gradientRotation); (h = this.createMarker(c, e, g, void 0, void 0, void 0, q, h)) && h.translate(m / 2, m / 2)
                } d.setCN(b, h, "legend-marker"); this.addListeners(h, a); l = l.set([h]); this.switchable && a.switchable && l.setAttr("cursor", "pointer"); void 0 !== a.id && d.setCN(b, l, "legend-item-" + a.id); d.setCN(b, l, a.className, !0); (f = this.switchType) && "none" != f && 0 < m && ("x" == f ? (p = this.createX(), p.translate(m / 2, m / 2)) : p = this.createV(), p.dItem = a, !0 !== a.hidden ? "x" == f ? p.hide() : p.show() : "x" != f && p.hide(), this.switchable || p.hide(),
                ...
                e, f, b.fontFamily, p, "start") : d.wrappedText(this.container, e, f, b.fontFamily, p, "start", !1, y, 0), d.setCN(b, y, "legend-label"), y.translate(this.lx + n, this.ly), l.push(y), b = y.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b)); this.entries[this.index] = l; a.legendEntry = this.entries[this.index]; a.legendLabel = y; this.index++
            }
        ...
        b, c) { b = { type: a, dataItem: b, target: this, event: c, chart: this.chart }; this.chart && this.chart.handleLegendEvent(b); this.fire(a, b) }, createValue: function (a) {
            var b = this, c = b.fontSize, e = b.chart; if (!1 !== a.visibleInLegend) {
                var g = b.maxLabelWidth; b.forceWidth && (g = b.labelWidth); b.equalWidths || (b.valueAlign = "left"); "left" == b.valueAlign && (g = a.legendEntry.getBBox().width); var f = g; if (b.valueText && 0 < b.valueWidth) {
                    var h = b.color; b.useMarkerColorForValues && (h = a.color, a.legendKeyColor && (h = a.legendKeyColor())); !0 === a.hidden &&
        ...
        b, c, e, g, f, h, k) { var l = this.markerSize, m = this.container; g || (g = this.markerBorderColor); g || (g = b); isNaN(e) && (e = this.markerBorderThickness); isNaN(f) && (f = this.markerBorderAlpha); return d.bullet(m, a, l, b, c, e, g, f, l, h, k, this.chart.path) }, validateNow: function () { this.invalidateSize() }, updateValues: function () {
            var a = this.valueLabels, b = this.chart, c, e = this.data; for (c = 0; c < a.length; c++) {
                var g = a[c], f = g.dItem, h = " "; if (e) f.value ? g.text(f.value) : g.text(""); else {
                    var k; if (void 0 !== f.type) {
                        k = f.currentDataItem; var l = this.periodValueText;
                        f.legendPeriodValueText && (l = f.legendPeriodValueText); k ? (h = this.valueText, f.legendValueText && (h = f.legendValueText), h = b.formatString(h, k)) : l && b.formatPeriodString && (l = d.massReplace(l, { "[[title]]": f.title }), h = b.formatPeriodString(l, f))
                    } else h = b.formatString(this.valueText, f); if (l = this.valueFunction) k && (f = k), h = l(f, h); g.text(h)
                }
            }
    ...
    var d = window.AmCharts; d.AmMap = d.Class({
        inherits: d.AmChart, construct: function (a) {
            ...
            "ammapAlert"), this.chartDiv.innerHTML = this.svgNotSupported, this.fire("failed", { type: "failed", chart: this }))
            ...
            d.resetMouseOver(); this.mouseIsDown = this.mouseIsOver = !0; this.balloon.hide(0); a && this.mouseIsOver && a.preventDefault && this.panEventsEnabled && a.preventDefault(); if (this.chartCreated && !this.preventHover && (this.initialTouchZoom =
            this.zoomLevel(), this.dragMap && (this.stopAnimation(), this.mapContainerClickX = this.mapContainer.x, this.mapContainerClickY = this.mapContainer.y), a || (a = window.event), a.shiftKey && !0 === this.developerMode && this.getDevInfo(), a && a.touches)) {
                var b = this.mouseX, c = this.mouseY, e = a.touches.item(1); e && this.panEventsEnabled && this.boundingRect && (a = e.clientX - this.boundingRect.left, e = e.clientY - this.boundingRect.top, this.middleXP = (b + (a - b) / 2) / this.realWidth, this.middleYP = (c + (e - c) / 2) / this.realHeight, this.initialDistance =
            ...
            if (d.isModern) {
                var a = this; a.mouseIsDown = !1; setTimeout(function () { a.resetPinch.call(a) }, 100); if (!a.preventHover) {
                    a.stopDrag(); var b = a.zoomControl; b && b.draggerUp && b.draggerUp(); a.mapWasDragged = !1; var b = a.mapContainer, c = a.mapContainerClickX, e = a.mapContainerClickY; isNaN(c) || isNaN(e) || !(2 < Math.abs(b.x - c) || Math.abs(b.y - e)) || (a.mapWasDragged = !0, b = {
            ...
            var b = this; d.AmMap.base.handleMouseMove.call(b, a); if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                b.mapContainer) {
                    var k = b.mouse2X, l = b.mouse2Y; b.pinchTO && clearTimeout(b.pinchTO); b.pinchTO = setTimeout(function () { b.resetPinch.call(b) }, 1E3); var m = b.realHeight, n = b.realWidth, r = b.mapWidth, t = b.mapHeight; b.mouseIsDown && b.dragMap && (5 < Math.abs(b.previuosMouseX - b.mouseX) || 5 < Math.abs(b.previuosMouseY - b.mouseY)) && (b.isDragging = !0); if (!isNaN(k)) {
                        b.stopDrag(); var p = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - f, 2)), q = b.initialDistance; isNaN(q) && (q = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - f, 2))); if (!isNaN(q)) {
                            var k = b.initialTouchZoom *
                            p / q, k = d.fitToBounds(k, h.minZoomLevel, h.maxZoomLevel), h = b.zoomLevel(), q = b.middleXP, l = b.middleYP, p = m / t, y = n / r, q = (b.zoomX() - q * y) * (k / h) + q * y, l = (b.zoomY() - l * p) * (k / h) + l * p; .1 < Math.abs(k - h) && (b.zoomTo(k, q, l, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
                        }
                    } k = a.scale; b.isDragging && (b.balloon.hide(0), b.positionChanged(), c = a.x + (g - c), e = a.y + (f - e), b.preventDragOut && (t = -t * k + m / 2, m /= 2, c = d.fitToBounds(c, -r * k + n / 2, n / 2), e = d.fitToBounds(e, t, m)), a.translate(c, e, k, !0), b.updateSmallMap()); b.previuosMouseX = g; b.previuosMouseY =
                    f
                }
            }
        }, selectObject: function (a, b) {
            var c = this; (new Date).getTime(); a || (a = c.dataProvider); a.isOver = !1; var e = a.linkToObject; "string" == typeof e && (e = c.getObjectById(e)); a.useTargetsZoomValues && e && (a.zoomX = e.zoomX, a.zoomY = e.zoomY, a.zoomLatitude = e.zoomLatitude, a.zoomLongitude = e.zoomLongitude, a.zoomLevel = e.zoomLevel); var g = c.selectedObject; g && c.returnInitialColor(g); c.selectedObject = a; var f = !1, h, k; "MapArea" == a.objectType && (a.autoZoomReal && (f = !0), h = c.areasSettings.selectedOutlineColor, k = c.areasSettings.selectedOutlineThickness);
            ...
            } c.zoomToSelectedObject(); g != a && (g = { type: "selectedObjectChanged", chart: c }, c.fire(g.type, g))
        }, returnInitialColor: function (a, b) {
            this.returnInitialColorReal(a); b && (a.isFirst = !1); if (this.selectedObject.bringForwardOnHover) {
                var c =
                this.selectedObject.displayObject; c && c.toFront()
            } if (c = a.groupId) { var c = this.getGroupById(c), e; for (e = 0; e < c.length; e++) this.returnInitialColorReal(c[e]), b && (c[e].isFirst = !1) }
            ...
            a.isOver = !1; var b = a.displayObject; if (b) {
                b.toPrevious(); if ("MapImage" == a.objectType) { var c = a.tempScale; isNaN(c) || b.translate(b.x, b.y, c, !0); a.tempScale = NaN; b = a.image } c = a.colorReal; if ("MapLine" == a.objectType) {
                    var e = a.lineSvg; e &&
                    e.setAttr("stroke", c); if (e = a.arrowSvg) e.setAttr("fill", c), e.setAttr("stroke", c)
                } var e = a.alphaReal, d = a.outlineAlphaReal, f = a.outlineThicknessReal, h = a.outlineColorReal; if (a.showAsSelected) { var c = a.selectedColorReal, k, l; "MapImage" == a.objectType && (k = this.imagesSettings.selectedOutlineColor, l = this.imagesSettings.selectedOutlineThickness); "MapArea" == a.objectType && (k = this.areasSettings.selectedOutlineColor, l = this.areasSettings.selectedOutlineThickness); void 0 !== k && (h = k); void 0 !== l && (f = l) } "bubble" == a.type &&
            ...
            g.bottomLatitude), f = d.fitToBounds(h / l > k / g ? .8 * l / h : .8 * g / k, f.minZoomLevel, f.maxZoomLevel); this.zoomToLongLat(f, a + (c - a) / 2, e + (b - e) / 2)
            ...
            a = "object" == typeof a ? a : this.getGroupById(a); var b, c, e, d, f; for (f = 0; f < a.length; f++) {
                var h = a[f].displayObject; if (h) {
                    var k = h.getBBox(), h = k.y, l = k.y + k.height,
                    m = k.x, k = k.x + k.width; if (h < b || isNaN(b)) b = h; if (l > d || isNaN(d)) d = l; if (m < c || isNaN(c)) c = m; if (k > e || isNaN(e)) e = k
                }
            } a = this.mapSet.getBBox(); c -= a.x; e -= a.x; d -= a.y; b -= a.y; this.zoomToRectangle(c, b, e - c, d - b)
        }, getGroup: function (a, b, c) { if (a) { var e; for (e = 0; e < a.length; e++) { var d = a[e]; d.groupId == b && c.push(d) } } }, zoomToStageXY: function (a, b, c, e) {
            if (!this.objectWasClicked) {
                var g = this.zoomControl; a = d.fitToBounds(a, g.minZoomLevel, g.maxZoomLevel); g = this.zoomLevel(); c = this.coordinateToLatitude((c - this.mapContainer.y) / g); b = this.coordinateToLongitude((b -
                this.mapContainer.x) / g); this.zoomToLongLat(a, b, c, e)
            }
        }, zoomToLongLat: function (a, b, c, e) { b = this.longitudeToCoordinate(b); c = this.latitudeToCoordinate(c); this.zoomToMapXY(a, b, c, e) }, zoomToMapXY: function (a, b, c, e) { var d = this.mapWidth, f = this.mapHeight; this.zoomTo(a, -(b / d) * a + this.realWidth / d / 2, -(c / f) * a + this.realHeight / f / 2, e) }, zoomToObject: function (a) {
            if (a) {
                var b = a.zoomLatitude, c = a.zoomLongitude, e = a.zoomLevel, g = this.zoomInstantly, f = a.zoomX, h = a.zoomY, k = this.realWidth, l = this.realHeight; isNaN(e) || (isNaN(b) || isNaN(c) ?
                ...
                l.maxZoomLevel), isNaN(a.zoomX) && isNaN(a.zoomY) && isNaN(a.zoomLatitude) && isNaN(a.zoomLongitude) && (a = this.mapSet.getBBox(), this.zoomToMapXY(k, -a.x * b + c + g / 2, -a.y * b + e + f / 2))); this.zoomControl.update()
            }
        }, zoomToSelectedObject: function () { this.zoomToObject(this.selectedObject) }, zoomTo: function (a, b, c, e) {
            var g = this.zoomControl; a = d.fitToBounds(a, g.minZoomLevel, g.maxZoomLevel); g = this.zoomLevel(); isNaN(b) && (b = this.realWidth / this.mapWidth, b = (this.zoomX() - .5 * b) * (a / g) + .5 * b); isNaN(c) && (c = this.realHeight / this.mapHeight,
            ...
            var b; window.XMLHttpRequest && (b = new XMLHttpRequest); b.overrideMimeType &&
            b.overrideMimeType("text/xml"); b.open("GET", a, !1); b.send(); this.parseXMLObject(b.responseXML); this.svgData && this.buildEverything()
            ...
            var a = this.selectedObject; if (0 < a.images.length || 0 < a.areas.length || 0 < a.lines.length || a == this.dataProvider) {
                var b = this.container, c = this.stageImagesContainer; c && c.remove(); this.stageImagesContainer = c = b.set(); this.trendLinesSet.push(c); var e = this.stageLinesContainer; e && e.remove(); this.stageLinesContainer =
                ...
                (this.linesProcessor.process(a), this.imagesProcessor.process(a))); this.rescaleObjects()
            }
        }, processAreas: function () { this.areasProcessor.process(this.dataProvider) }, buildSVGMap: function () {
            var a = this.svgData.g.path, b = this.container, c = b.set(); void 0 === a.length && (a = [a]); var e; for (e = 0; e < a.length; e++) {
                var d = a[e], f = d.d, h = d.title; d.titleTr && (h = d.titleTr); f = b.path(f); f.id = d.id; if (this.areasSettings.preserveOriginalAttributes) { f.customAttr = {}; for (var k in d) "d" != k && "id" != k && "title" != k && (f.customAttr[k] = d[k]) } this.svgAreasById[d.id] =
                { area: f, title: h, className: d["class"] }; this.svgAreas.push(f); c.push(f)
        ...
        showAsRolledOver: function (a) {
            var b = a.displayObject; if (!a.showAsSelected && b && !a.isOver) {
                ...
                1), a.tempScale = e, b.translate(b.x, b.y, e * c, !0))); this.useHandCursorOnClickableOjects && this.checkIfClickable(a) && b.setAttr("cursor", "pointer"); this.addObjectEventListeners(b, a); a.isOver = !0
            }
            ...
            if (this.chartCreated) {
                this.handleMouseMove(); var d = this.previouslyHovered; d && d != a ? (!1 === this.checkIfSelected(d) && (this.returnInitialColor(d, !0), this.previouslyHovered = null), this.balloon.hide(0)) : clearTimeout(this.hoverInt); if (!this.preventHover) {
                    if (!1 === this.checkIfSelected(a)) {
                        if (d =
                        a.groupId) { var d = this.getGroupById(d), g; for (g = 0; g < d.length; g++) d[g] != a && this.showAsRolledOver(d[g]) } this.showAsRolledOver(a)
                    ...
                    (d = this.formatString(g, a)), this.balloonLabelFunction && (d = this.balloonLabelFunction(a, this)), "MapArea" != a.objectType && (this.balloonX = NaN), d && "" !== d && this.showBalloon(d, b, !1, this.balloonX, this.balloonY)); c = { type: "rollOverMapObject", mapObject: a, chart: this, event: c }; this.fire(c.type, c); this.previouslyHovered = a
                }
            }
        }, longitudeToX: function (a) { return this.longitudeToCoordinate(a) * this.zoomLevel() + this.mapContainer.x }, latitudeToY: function (a) { return this.latitudeToCoordinate(a) * this.zoomLevel() + this.mapContainer.y },
        latitudeToStageY: function (a) { return this.latitudeToCoordinate(a) * this.zoomLevel() + this.mapContainer.y }, longitudeToStageX: function (a) { return this.longitudeToCoordinate(a) * this.zoomLevel() + this.mapContainer.x }, stageXToLongitude: function (a) { a = (a - this.mapContainer.x) / this.zoomLevel(); return this.coordinateToLongitude(a) }, stageYToLatitude: function (a) { a = (a - this.mapContainer.y) / this.zoomLevel(); return this.coordinateToLatitude(a) }, rollOutMapObject: function (a, b) {
            this.hideBalloon(); if (this.chartCreated && a.isOver) {
                this.checkIfSelected(a) ||
                this.returnInitialColor(a); var c = { type: "rollOutMapObject", mapObject: a, chart: this, event: b }; this.fire(c.type, c)
            }
        ...
        b) { var c = { type: "mouseDownMapObject", mapObject: a, chart: this, event: b }; this.fire(c.type, c) }, clickMapObject: function (a, b) {
            var c = this; b && (b.touches || c.hideBalloon()); if (c.chartCreated && !c.preventHover && !c.mapWasDragged && c.checkIfClickable(a) && !c.mapWasPinched) {
                c.selectObject(a); var d = c.zoomLevel(); c.clickLatitude = c.coordinateToLatitude((c.mouseY - c.mapContainer.y) / d); c.clickLongitude = c.coordinateToLongitude((c.mouseX - c.mapContainer.x) / d); b && b.touches && setTimeout(function () { c.showBalloonAfterZoom.call(c) },
                1E3 * c.zoomDuration); d = { type: "clickMapObject", mapObject: a, chart: c, event: b }; c.fire(d.type, d); c.objectWasClicked = !0
            }
            ...
            var b = this.allowClickOnSelectedObject; return this.selectedObject == a && b ? !0 : this.selectedObject != a || b ? !0 === a.selectable || "MapArea" == a.objectType && a.autoZoomReal || a.url || a.linkToObject ||
            0 < a.images.length || 0 < a.lines.length || !isNaN(a.zoomLevel) || !isNaN(a.zoomX) || !isNaN(a.zoomY) || a.description ? !0 : !1 : !1
        }, resizeMap: function () { var a = this.mapSet; if (a) { var b = 1, c = a.getBBox(), d = this.realWidth, g = this.realHeight, f = c.width, h = c.height; this.fitMapToContainer && (b = f / d > h / g ? d / f : g / h); a.translate(-c.x * b, -c.y * b, b, !0); this.mapScale = b; this.mapHeight = h * b; this.mapWidth = f * b } }, zoomIn: function () { var a = this.zoomLevel() * this.zoomControl.zoomFactor; this.zoomTo(a) }, zoomOut: function () {
            var a = this.zoomLevel() / this.zoomControl.zoomFactor;
            this.zoomTo(a)
        }, moveLeft: function () { var a = this.zoomX() + this.zoomControl.panStepSize; this.zoomTo(this.zoomLevel(), a, this.zoomY()) }, moveRight: function () { var a = this.zoomX() - this.zoomControl.panStepSize; this.zoomTo(this.zoomLevel(), a, this.zoomY()) }, moveUp: function () { var a = this.zoomY() + this.zoomControl.panStepSize; this.zoomTo(this.zoomLevel(), this.zoomX(), a) }, moveDown: function () { var a = this.zoomY() - this.zoomControl.panStepSize; this.zoomTo(this.zoomLevel(), this.zoomX(), a) }, zoomX: function () {
            return this.mapSet ?
            Math.round(1E4 * this.mapContainer.x / this.mapWidth) / 1E4 : NaN
        }, zoomY: function () { return this.mapSet ? Math.round(1E4 * this.mapContainer.y / this.mapHeight) / 1E4 : NaN }, goHome: function () { this.selectObject(this.dataProvider); var a = { type: "homeButtonClicked", chart: this }; this.fire(a.type, a) }, zoomLevel: function () { return Math.round(1E5 * this.mapContainer.scale) / 1E5 }, showDescriptionAndGetUrl: function () {
            var a = this.selectedObject; if (a) {
                this.showDescription(); var b = a.url; if (b) d.getURL(b, a.urlTarget); else if (b = a.linkToObject) {
                    if ("string" ==
                    typeof b) { var c = this.getObjectById(b); if (c) { this.selectObject(c); return } } b && a.passZoomValuesToTarget && (b.zoomLatitude = this.zoomLatitude(), b.zoomLongitude = this.zoomLongitude(), b.zoomLevel = this.zoomLevel()); this.extendMapData(b) || this.selectObject(b)
                }
            }
        }, extendMapData: function (a) { var b = a.objectType; if ("MapImage" != b && "MapArea" != b && "MapLine" != b) return d.extend(a, new d.MapData, !0), this.dataProvider = a, this.zoomInstantly = !0, this.validateData(), !0 }, showDescription: function (a) {
            a || (a = this.selectedObject); this.allowMultipleDescriptionWindows ||
            this.closeAllDescriptions(); if (a.description) {
                ...
                isNaN(f) && (f = this.mouseY); b.maxHeight = e; l = a.title; a.titleTr && (l = a.titleTr); b.show(this, this.descriptionsDiv, a.description, l); a = b.div.style; a.position = "absolute"; a.width = c + "px"; a.maxHeight = e + "px"; isNaN(k) || (f -= b.div.offsetHeight); isNaN(h) || (g -= b.div.offsetWidth); a.left = g + "px"; a.top = f + "px"
            }
        }, parseXMLObject: function (a) { var b = { root: {} }; this.parseXMLNode(b, "root", a); this.svgData = b.root.svg; this.getBounds() }, getBounds: function () {
            var a = this.dataProvider; try {
                var b = this.svgData.defs["amcharts:ammap"]; a.leftLongitude =
                Number(b.leftLongitude); a.rightLongitude = Number(b.rightLongitude); a.topLatitude = Number(b.topLatitude); a.bottomLatitude = Number(b.bottomLatitude); a.projection = b.projection; var c = b.wrappedLongitudes; c && (a.rightLongitude += 360); a.wrappedLongitudes = c
            } catch (d) { }
        }, recalcLongitude: function (a) { var b = this.dataProvider.leftLongitude, c = this.dataProvider.wrappedLongitudes; return isNaN(a) && c ? a < b ? Number(a) + 360 : a : a }, latitudeToCoordinate: function (a) {
            var b, c = this.dataProvider; if (this.mapSet) {
                b = c.topLatitude; var d = c.bottomLatitude;
        ...
        }, longitudeToCoordinate: function (a) { a = this.recalcLongitude(a); var b, c = this.dataProvider; this.mapSet && (b = c.leftLongitude, b = (a - b) / (c.rightLongitude - b) * this.mapWidth); return b }, mercatorLatitudeToCoordinate: function (a) {
            89.5 < a && (a = 89.5); -89.5 > a && (a = -89.5); a = d.degreesToRadians(a); a = .5 * Math.log((1 + Math.sin(a)) / (1 - Math.sin(a)));
            return d.radiansToDegrees(a / 2)
        }, zoomLatitude: function () { if (this.mapContainer) return this.coordinateToLatitude((-this.mapContainer.y + this.previousHeight / 2) / this.zoomLevel()) }, zoomLongitude: function () { if (this.mapContainer) return this.coordinateToLongitude((-this.mapContainer.x + this.previousWidth / 2) / this.zoomLevel()) }, getAreaCenterLatitude: function (a) { a = a.displayObject.getBBox(); var b = this.mapScale; a = -this.mapSet.getBBox().y * b + (a.y + a.height / 2) * b; return this.coordinateToLatitude(a) }, getAreaCenterLongitude: function (a) {
            a =
            a.displayObject.getBBox(); var b = this.mapScale; a = -this.mapSet.getBBox().x * b + (a.x + a.width / 2) * b; return this.coordinateToLongitude(a)
        }, coordinateToLatitude: function (a) { var b; if (this.mapSet) { var c = this.dataProvider, e = c.bottomLatitude, g = c.topLatitude; b = this.mapHeight; "mercator" == c.projection ? (c = this.mercatorLatitudeToCoordinate(e), g = this.mercatorLatitudeToCoordinate(g), a = 2 * Math.atan(Math.exp(2 * (a * (c - g) / b + g) * Math.PI / 180)) - .5 * Math.PI, b = d.radiansToDegrees(a)) : b = a / b * (e - g) + g } return Math.round(1E6 * b) / 1E6 }, coordinateToLongitude: function (a) {
            var b,
            c = this.dataProvider; this.mapSet && (b = a / this.mapWidth * (c.rightLongitude - c.leftLongitude) + c.leftLongitude); return Math.round(1E6 * b) / 1E6
        }, milesToPixels: function (a) { var b = this.dataProvider; return this.mapWidth / (b.rightLongitude - b.leftLongitude) * a / 69.172 }, kilometersToPixels: function (a) { var b = this.dataProvider; return this.mapWidth / (b.rightLongitude - b.leftLongitude) * a / 111.325 }, handleBackgroundClick: function () {
            if (this.backgroundZoomsToTop && !this.mapWasDragged) {
                var a = this.dataProvider; if (this.checkIfClickable(a)) this.clickMapObject(a);
                else { var b = a.zoomX, c = a.zoomY, d = a.zoomLongitude, g = a.zoomLatitude, a = a.zoomLevel; isNaN(b) || isNaN(c) || this.zoomTo(a, b, c); isNaN(d) || isNaN(g) || this.zoomToLongLat(a, d, g, !0) }
            }
        }, parseXMLNode: function (a, b, c, d) {
            void 0 === d && (d = ""); var g, f, h; if (c) {
                var k = c.childNodes.length; for (g = 0; g < k; g++) {
                    f = c.childNodes[g]; var l = f.nodeName, m = f.nodeValue ? this.trim(f.nodeValue) : "", n = !1; f.attributes && 0 < f.attributes.length && (n = !0); if (0 !== f.childNodes.length || "" !== m || !1 !== n) if (3 == f.nodeType || 4 == f.nodeType) {
                        if ("" !== m) {
                            f = 0; for (h in a[b]) a[b].hasOwnProperty(h) &&
                            f++; f ? a[b]["#text"] = m : a[b] = m
                        }
                    } else if (1 == f.nodeType) { var r; void 0 !== a[b][l] ? void 0 === a[b][l].length ? (r = a[b][l], a[b][l] = [], a[b][l].push(r), a[b][l].push({}), r = a[b][l][1]) : "object" == typeof a[b][l] && (a[b][l].push({}), r = a[b][l][a[b][l].length - 1]) : (a[b][l] = {}, r = a[b][l]); if (f.attributes && f.attributes.length) for (m = 0; m < f.attributes.length; m++) r[f.attributes[m].name] = f.attributes[m].value; void 0 !== a[b][l].length ? this.parseXMLNode(a[b][l], a[b][l].length - 1, f, d + "  ") : this.parseXMLNode(a[b], l, f, d + "  ") }
                } f = 0; c =
                ""; for (h in a[b]) "#text" == h ? c = a[b][h] : f++; 0 === f && void 0 === a[b].length && (a[b] = c)
            }
            ...
            var a = this.zoomLevel(), a = {
                chart: this, type: "writeDevInfo", zoomLevel: a, zoomX: this.zoomX(), zoomY: this.zoomY(), zoomLatitude: this.zoomLatitude(), zoomLongitude: this.zoomLongitude(), latitude: this.coordinateToLatitude((this.mouseY - this.mapContainer.y) / a),
                longitude: this.coordinateToLongitude((this.mouseX - this.mapContainer.x) / a), left: this.mouseX, top: this.mouseY, right: this.realWidth - this.mouseX, bottom: this.realHeight - this.mouseY, percentLeft: Math.round(this.mouseX / this.realWidth * 100) + "%", percentTop: Math.round(this.mouseY / this.realHeight * 100) + "%", percentRight: Math.round((this.realWidth - this.mouseX) / this.realWidth * 100) + "%", percentBottom: Math.round((this.realHeight - this.mouseY) / this.realHeight * 100) + "%"
            }, b = "zoomLevel:" + a.zoomLevel + ", zoomLongitude:" + a.zoomLongitude +
            ", zoomLatitude:" + a.zoomLatitude + "\n", b = b + ("zoomX:" + a.zoomX + ", zoomY:" + a.zoomY + "\n"), b = b + ("latitude:" + a.latitude + ", longitude:" + a.longitude + "\n"), b = b + ("left:" + a.left + ", top:" + a.top + "\n"), b = b + ("right:" + a.right + ", bottom:" + a.bottom + "\n"), b = b + ("left:" + a.percentLeft + ", top:" + a.percentTop + "\n"), b = b + ("right:" + a.percentRight + ", bottom:" + a.percentBottom + "\n"); a.str = b; this.fire(a.type, a); return a
        }, getXY: function (a, b, c) {
            void 0 !== a && (-1 != String(a).indexOf("%") ? (a = Number(a.split("%").join("")), c && (a = 100 - a), a =
            Number(a) * b / 100) : c && (a = b - a)); return a
        }, getObjectById: function (a) { var b = this.dataProvider; if (b.areas) { var c = this.getObject(a, b.areas); if (c) return c } if (c = this.getObject(a, b.images)) return c; if (a = this.getObject(a, b.lines)) return a }, getObject: function (a, b) { if (b) { var c; for (c = 0; c < b.length; c++) { var d = b[c]; if (d.id == a) return d; if (d.areas) { var g = this.getObject(a, d.areas); if (g) return g } if (g = this.getObject(a, d.images)) return g; if (d = this.getObject(a, d.lines)) return d } } }, parseData: function () {
            ...
            if (a) {
                var e; for (e = 0; e < a.length; e++) {
                    var g = a[e]; g.parentObject = b; "area" == c && d.extend(g, new d.MapArea(this.theme), !0); "image" == c && (g = d.extend(g, new d.MapImage(this.theme), !0)); "line" == c && (g = d.extend(g, new d.MapLine(this.theme), !0)); a[e] = g; g.areas && this.processObject(g.areas, g, "area"); g.images && this.processObject(g.images, g, "image"); g.lines && this.processObject(g.lines,
                    g, "line")
                }
            }
        }, positionChanged: function () { var a = { type: "positionChanged", zoomX: this.zoomX(), zoomY: this.zoomY(), zoomLevel: this.zoomLevel(), chart: this }; this.fire(a.type, a) }, getX: function (a, b) { return this.getXY(a, this.realWidth, b) }, getY: function (a, b) { return this.getXY(a, this.realHeight, b) }, trim: function (a) {
            if (a) {
    ...
    var d = window.AmCharts; d.ZoomControl = d.Class({
        construct: function (a) {
            ...
            n = c.buttonBorderColor, r = c.buttonBorderAlpha, t = c.buttonCornerRadius, p = c.buttonRollOverColor, q = c.gridHeight, y = c.zoomFactor, z = c.minZoomLevel, C = c.maxZoomLevel, A = c.buttonIconAlpha, w = c.buttonIconColor, x = c.roundButtons, D = a.svgIcons, u = a.getX(c.left), v = a.getY(c.top); isNaN(c.right) || (u = a.getX(c.right, !0), u = h ? u - 3 * g : u - g); isNaN(c.bottom) || (v = a.getY(c.bottom, !0), f && (v -= q + 3 * g), v = h ? v - 3 * g : c.homeButtonEnabled ? v - .5 * g : v + g); e.translate(u, v); c.previousDY = NaN; var F, u = g / 4 - 1; if (f) {
                ...
                D ? v.svgIcon = d.line(b, [-u, u], [0, 0], w, A, 1) : v.setIcon(a.pathToImages + "minus.gif", c.iconSize); v.setClickHandler(a.zoomOut, a); v.init(b, g, g, k, l, m, n, r, t, p, A, w, x); v.set.translate(0, q + g); d.setCN(a, v.set, "zoom-out"); F.push(v.set); q -= f; z = Math.log(z / 100) / Math.log(y); y = Math.log(C / 100) / Math.log(y); c.realStepSize = q / (y - z); c.realGridHeight = q; c.stepMax = y
            ...
            this.stepMax - (a.mouseY - this.zoomSet.y - this.set.y - this.buttonSize - this.realStepSize / 2) / this.realStepSize); a.zoomTo(b)
        }, update: function () {
    ...
    var d = window.AmCharts; d.SimpleButton = d.Class({
        construct: function () { }, init: function (a, b, c, e, g, f, h, k, l, m, n, r, t) {
            var p = this; p.rollOverColor = m; p.color = e; p.container = a; m = a.set(); p.set = m; t ? (b /= 2, e = d.circle(a, b, e, g, f, h, k), e.translate(b, b)) : e = d.rect(a, b, c, e, g, f, h, k, l); m.push(e); g = p.iconPath; var q; g && (q = p.iconSize, f = (b - q) / 2, t && (f = (2 * b - q) / 2), q = a.image(g, f, (c - q) / 2, q, q)); p.svgIcon && (q = p.svgIcon, t ? q.translate(b, b) : q.translate(b / 2, b / 2)); m.setAttr("cursor", "pointer"); q && (m.push(q), q.setAttr("opacity",
    ...
    var d = window.AmCharts; d.AreasProcessor = d.Class({
        construct: function (a) { this.chart = a }, process: function (a) {
            ...
            a.balloonTextReal = m; a.selectedColorReal = z; a.outlineColorReal = f; a.outlineAlphaReal = t; a.rollOverOutlineColorReal = k; a.outlineThicknessReal = p; a.patternReal = l; a.rollOverBrightnessReal = C; d.processDescriptionWindow(e, a); if (c && (r = c.area, A = c.title, a.enTitle = c.title, A && !a.title && (a.title = A), (c = b.language) ? (A = d.mapTranslations) && (c = A[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle]) : a.titleTr = void 0, r)) {
                a.displayObject = r; a.mouseEnabled && b.addObjectEventListeners(r, a); var D; void 0 != g && (D = g); void 0 != a.colorReal && (D =
    ...
    var d = window.AmCharts; d.ImagesProcessor = d.Class({
        construct: function (a) { this.chart = a; this.reset() }, process: function (a) { var b = a.images, c; for (c = 0; c < b.length; c++) { var d = b[c]; this.createImage(d, c); d.parentArray = b } this.counter = c; a.parentObject && a.remainVisible && this.process(a.parentObject) }, createImage: function (a, b) {
            ...
            C = a.type; z = a.imageURL; x = a.svgPath; F = a.width; q = a.height; n = a.scale; isNaN(a.percentWidth) || (F = a.percentWidth / 100 * c.realWidth); isNaN(a.percentHeight) || (q = a.percentHeight / 100 * c.realHeight); var B; z || C || x || (C = "circle", F = 1, l = k = 0); u = v = 0; h = a.selectedColorReal; if (C) {
                isNaN(F) && (F = 10); isNaN(q) && (q = 10); "kilometers" == a.widthAndHeightUnits && (F = c.kilometersToPixels(a.width), q = c.kilometersToPixels(a.height)); "miles" == a.widthAndHeightUnits && (F = c.milesToPixels(a.width), q = c.milesToPixels(a.height)); if ("circle" == C || "bubble" ==
                C) q = F; B = this.createPredefinedImage(G, t, p, C, F, q); u = v = 0; a.centeredReal ? (isNaN(a.right) || (v = F * n), isNaN(a.bottom) || (u = q * n)) : (v = F * n / 2, u = q * n / 2); B.translate(v, u, n, !0)
            ...
            (e = !1); e ? f.push(E) : g.push(E); E && (E.rotation = a.rotation, isNaN(a.rotation) || E.rotate(a.rotation)); this.updateSizeAndPosition(a); a.mouseEnabled && c.addObjectEventListeners(E, a); a.hidden && E.hide(); a.animateAlongLine && setTimeout(function () { a.animateAlong.call(a) }, 100); return a
        }, updateSizeAndPosition: function (a) {
            var b = this.chart, c = a.displayObject, e = b.getX(a.left), g = b.getY(a.top), f, h = a.image.getBBox(); isNaN(a.right) || (e = b.getX(a.right, !0) - h.width * a.scale); isNaN(a.bottom) || (g = b.getY(a.bottom, !0) - h.height *
            ...
            if (a) {
                var d = b.image, g = 0, f = 0, h = 0, k = 0; d && (k = d.getBBox(), f = d.y, g = d.x, h = k.width, k = k.height, b.svgPath && (h *= b.scale, k *= b.scale)); var d = a.getBBox(), l = d.width, m = d.height; "right" == c && (g += h + l / 2 + 5, f += k / 2 - 2); "left" == c && (g += -l / 2 - 5, f += k / 2 - 2); "top" == c && (f -= m / 2 + 3, g += h / 2); "bottom" == c && (f += k + m / 2, g += h / 2); "middle" == c && (g += h / 2, f += k / 2); a.translate(g + b.labelShiftX, f + b.labelShiftY, NaN, !0); b.labelBG && b.labelBG.translate(g - d.width / 2 + b.labelShiftX - 9, f + b.labelShiftY - d.height /
                2 - 3, NaN, !0)
            }
    ...
    var d = window.AmCharts; d.LinesProcessor = d.Class({
        construct: function (a) { this.chart = a; this.reset() }, process: function (a) { var b = a.lines, c; for (c = 0; c < b.length; c++) { var d = b[c]; this.createLine(d, c); d.parentArray = b } this.counter = c; a.parentObject && a.remainVisible && this.process(a.parentObject) }, createLine: function (a, b) {
            ...
            a); if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                n.length; if (0 < q) for (w = [], C = 0; C < q; C++) w.push(c.longitudeToCoordinate(n[C])); q = e.length; if (0 < q) for (D = [], C = 0; C < q; C++) D.push(c.latitudeToCoordinate(e[C])); if (0 < w.length) {
                    a.segments = w.length; d.dx = 0; d.dy = 0; var E, G, B, n = 10 * (1 - Math.abs(A)); 10 <= n && (n = NaN); 1 > n && (n = 1); a.arcRadius = []; a.distances = []; if (isNaN(n)) { for (n = 0; n < w.length - 1; n++) G = D[n], q = D[n + 1], G = Math.sqrt(Math.pow(w[n + 1] - w[n], 2) + Math.pow(q - G, 2)), a.distances[n] = G; n = d.line(u, w, D, l, 1, F, k, !1, !1, !0); l = d.line(u, w, D, l, .001, 5, k, !1, !1, !0) } else {
                        q = 1; 0 > A && (q = 0); C =
                        { fill: "none", stroke: l, "stroke-opacity": 1, "stroke-width": F, "fill-opacity": 0 }; void 0 !== k && 0 < k && (C["stroke-dasharray"] = k); k = ""; for (z = 0; z < w.length - 1; z++) { var I = w[z], J = w[z + 1], M = D[z], N = D[z + 1]; G = Math.sqrt(Math.pow(J - I, 2) + Math.pow(N - M, 2)); B = G / 2 * n; E = 270 + 180 * Math.acos(G / 2 / B) / Math.PI; isNaN(E) && (E = 270); if (I < J) { var O = I, I = J, J = O, O = M, M = N, N = O; E = -E } 0 < A && (E = -E); k += "M" + I + "," + M + "A" + B + "," + B + ",0,0," + q + "," + J + "," + N; a.arcRadius[z] = B; a.distances[z] = G } n = u.path(k).attr(C); l = u.path(k).attr({
                            "fill-opacity": 0, stroke: l, "stroke-width": 5,
                            "stroke-opacity": .001, fill: "none"
                        })
                    } d.setCN(c, n, "map-line"); void 0 != a.id && d.setCN(c, n, "map-line-" + a.id); d.dx = .5; d.dy = .5; v.push(n); v.push(l); n.setAttr("opacity", p); if ("none" != x) {
                        var H, K, L; if ("end" == x || "both" == x) p = w[w.length - 1], q = D[D.length - 1], 1 < w.length ? (k = w[w.length - 2], H = D[D.length - 2]) : (k = p, H = q), H = 180 * Math.atan((q - H) / (p - k)) / Math.PI, isNaN(E) || (H += E), K = p, L = q, H = 0 > p - k ? H - 90 : H + 90; "both" == x && (p = d.polygon(u, [-t / 2, 0, t / 2], [1.5 * t, 0, 1.5 * t], m, r, 1, m, r), v.push(p), p.translate(K, L, 1, !0), isNaN(H) || p.rotate(H), d.setCN(c,
                        ...
                        E * B, L += Math.cos(H / 180 * Math.PI) * B), H = 0 > p - k ? H - 90 : H + 90); p = d.polygon(u, [-t / 2, 0, t / 2], [1.5 * t, 0, 1.5 * t], m, r, 1, m, r); d.setCN(c, n, "map-line-arrow"); void 0 != a.id && d.setCN(c, n, "map-line-arrow-" + a.id); v.push(p); p.translate(K, L, 1, !0); isNaN(H) || p.rotate(H); a.fixedSize && (g.push(p), a.arrays.push({ arr: g, el: p })); a.arrowSvg = p
                    } a.fixedSize && n && (c = { line: n, thickness: F }, this.linesToResize.push(c), a.arrays.push({ arr: this.linesToResize, el: c }), c = { line: l, thickness: 5 }, this.linesToResize.push(c), a.arrays.push({
                        arr: this.linesToResize,
                        el: c
                    })); a.lineSvg = n; a.showAsSelected && !isNaN(y) && n.setAttr("stroke", y); 0 < e.length ? f.push(v) : h.push(v); a.hidden && v.hide()
                }
            }
        ...
        inherits: d.MapObject, construct: function (a) { this.cname = "MapLine"; this.longitudes = []; this.latitudes = []; this.x = []; this.y = []; this.segments = 0; this.arrow = "none"; d.MapLine.base.construct.call(this, a); d.applyTheme(this, a, this.cname) }, validate: function () { this.chart.linesProcessor.createLine(this) }, remove: function () { var a = this.displayObject; a && a.remove() }, getCoordinates: function (a, b) {
            isNaN(b) && (b = 0); if (!isNaN(a)) {
                ...
                (c = this.chart.longitudeToCoordinate(this.longitudes[b]), g = this.chart.longitudeToCoordinate(this.longitudes[b + 1]), e = this.chart.latitudeToCoordinate(this.latitudes[b]), f = this.chart.latitudeToCoordinate(this.latitudes[b + 1])) : 1 < this.x.length && (c = this.x[b], g = this.x[b + 1], e = this.y[b], f = this.y[b + 1]); var l = Math.sqrt(Math.pow(g - c, 2) + Math.pow(f - e, 2)); c < g && !isNaN(this.arc) && (a = 1 - a); h = c + (g - c) * a; k = e + (f - e) * a; var m = Math.atan2(f - e, g - c); if (!isNaN(this.arc) && this.arcRadius) {
                    ...
                    k = this.arcRadius[b]; var r = e + (f - e) / 2; 0 > this.arc && (l = -l); h = c + (g - c) / 2 + Math.sqrt(k * k - l / 2 * (l / 2)) * (e - f) / l; r += Math.sqrt(k * k - l / 2 * (l / 2)) * (g - c) / l; c = 180 * Math.atan2(e - r, c - h) / Math.PI; g = 180 * Math.atan2(f - r, g - h) / Math.PI; m = d.degreesToRadians(c + (g - c) * a); h += k * Math.cos(m); k = r + k * Math.sin(m); m = 0 < this.arc ? m + Math.PI / 2 : m - Math.PI / 2; m += n
    ...
    var d = window.AmCharts; d.MapImage = d.Class({
        ...
        remove: function () { var a = this.displayObject; a && a.remove(); (a = this.imageLabel) && a.remove() }, animateTo: function (a, b, c, d) {
            ...
            var a = this, b = a.chart.imagesSettings, c = a.animationDuration; isNaN(c) && (c = b.animationDuration); a.totalFrames = Math.round(1E3 * c / d.updateRate); c = 1; a.line && b.adjustAnimationSpeed && (a.line.distances && (c = a.line.distances[a.lineSegment] * a.chart.zoomLevel(), c = Math.abs(c / b.baseAnimationDistance)), a.totalFrames =
            Math.round(c * a.totalFrames)); a.frame = 0; a.clearTO(); a.timeOut = setTimeout(function () { a.update.call(a) }, d.updateRate); b = { type: "animationStart", chart: a.chart, image: this, lineSegment: a.lineSegment, direction: a.direction }; a.fire(b.type, b)
        }, clearTO: function () { this.timeOut && clearTimeout(this.timeOut) }, update: function () {
            var a = this; a.updatePosition(); var b = Math.round(1E3 / d.updateRate), c = a.chart.imagesSettings, e = a.easingFunction; e || (e = c.easingFunction); a.frame++; c = a.totalFrames; a.frame <= c ? (e = e(0, a.frame, 0, 1, c),
            ...
            var a = this; a.clearTO(); a.timeOut = setTimeout(function () { a.animateAlong.call(a) },
            1E3 * a.chart.imagesSettings.pauseDuration)
        }, fixToStage: function () { isNaN(this.longitude) || (this.left = this.chart.longitudeToStageX(this.longitude), this.longitude = void 0); isNaN(this.latitude) || (this.top = this.chart.latitudeToStageY(this.latitude), this.latitude = void 0); this.validate() }, fixToMap: function () { isNaN(this.left) || (this.longitude = this.chart.stageXToLongitude(this.left), this.left = void 0); isNaN(this.top) || (this.latitude = this.chart.stageYToLatitude(this.top), this.top = void 0); this.validate() }
    })
})(); (function () {
